...
import { CreateBatchRequest, GetAllBatchRequest, GetBatchRequest, GetStudentsOfBatchRequest, UpdateBatchRequest } from "./types";
...
export const getBatchDetails = createAsyncThunk( "getBatchDetails/Batch", async (data: GetBatchRequest, thunkAPI) => {
        thunkAPI.dispatch(updateLoading(1));
        try {
            const config = {
                headers: {
            ...
            const res = await axios.put(`/institute/b/get-details/${data.batchId}`, data, config);
...
export const deleteBatch = createAsyncThunk( "deleteBatch/Batch", async (data: GetBatchRequest, thunkAPI) => {
        thunkAPI.dispatch(updateLoading(1));
        try {
            const config = {
                headers: {
            ...
            const res = await axios.put(`/institute/b/delete/${data.batchId}`, data, config);
...
export const getStudentsOfBatch = createAsyncThunk( "getStudentsOfBatch/Batch", async (data: GetStudentsOfBatchRequest, thunkAPI) => {
    thunkAPI.dispatch(updateLoading(1));
    try {
        const config = {
            headers: {
        ...
        const res = await axios.put(`/institute/b/students`, data, config);
