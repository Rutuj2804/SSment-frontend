...
export const createVendor = createAsyncThunk( "createVendor/Institute", async (data: CreateInstituteRequest, thunkAPI) => {
        thunkAPI.dispatch(updateLoading(1));
        try {
            const config = {
                headers: {
            ...
            const res = await axios.post(`/institute/v/create`, data, config);
...
export const getAllInstitutes = createAsyncThunk( "getAllInstitutes/Institute", async (data: BaseInterface, thunkAPI) => {
        thunkAPI.dispatch(updateLoading(1));
        try {
            const config = {
                headers: {
...
export const getAllVendors = createAsyncThunk( "getAllVendors/Institute", async (data: BaseInterface, thunkAPI) => {
        thunkAPI.dispatch(updateLoading(1));
        try {
            const config = {
                headers: {
            ...
            const res = await axios.put(`/institute/v/get-all`, data, config);
