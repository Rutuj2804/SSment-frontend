...
const YesNoType = ({ question, serialNumber, testId }: YesNoTypeInterface) => {
	...
	return (
		<div className="multipleChoiceQuestion__Wrapper">
			...
			<div onClick={() => onOptionClick(true)} className={optionSelected === true ? "multipleChoiceQuestion__Choice multipleChoiceQuestion__Selected" : "multipleChoiceQuestion__Choice" }>Yes</div>
				<div onClick={() => onOptionClick(false)} className={optionSelected === false ? "multipleChoiceQuestion__Choice multipleChoiceQuestion__Selected" : "multipleChoiceQuestion__Choice" }>No</div>
			</div>
		</div>
	);
};
